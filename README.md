...
*Utilização de Inteligência Artificial dentro da IDE para auxiliar no desenvolvimento do sistema de apagar o banco de dados local quando encerrando o servidor, desenvolvido bastante tempo após o projeto original.*
