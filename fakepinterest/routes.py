...
@app.route("/", methods=["GET", "POST"]) #define o link que aparece como url
def homepage():
    formlogin = FormLogin()
    ...
    return render_template("homepage.html", form=formlogin) #define o que aparece no site
...
def perfil(id_usuario):
    if int(id_usuario) == int(current_user.id):
        ...
        if formfoto.validate_on_submit():
            ...
            #registrar esse arquivo no campo de dados
